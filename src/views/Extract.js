...
class Extract extends React.Component {
    ...
    // 嵌入对话框
    handleOk = () => {
        this.setState({ extract: true })
    }
    extract = () => {
        Modal.confirm({
            title: '已选择含水印图片' + this.state.fileList.length + '张，是否确认提取?',
                    ...
                    <Col span={12}>
                        ...
                        >
                            ...
                            <Form.Item
                                ...
                                style={{ height: "248px" }}
                            >
                                <div style={{ border: "1px solid blue", background:"aliceblue", padding: "10px", width: "360px", height: "260px" }}>
                            ...
                            <Form.Item wrapperCol={{ offset: 6, span: 16 }} >
                                ...
                                <div style={{ position: "absolute", bottom: "-20px" }}>
                                    <Button type="primary" htmlType="submit" style={{ width: "220px", height: "45px", fontSize: "22px", fontFamily: "微软雅黑" }} onClick={this.extract}>
                                        提取水印
                                    </Button>
                            ...
                            {this.state.extract ?
                                <>
                                    <Form.Item wrapperCol={{ offset: 3, span: 16 }} >
                                        <div style={{ border: "1px solid blue", background:"aliceblue", padding: "10px", width: "470px", height: "260px" }}>

                                            <PicturesWall fileList={this.state.wm_fileList} uploadButton={false} handleCancel={this.handleCancel} handlePreview={this.handlePreview} handleChange={this.handleChange}></PicturesWall>
                                        </div>
